<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about_us.aspx.cs" Inherits="project.WebForm11" %>
...
<body>
	...
	<a href=""><img src="images/a.png" style="height: 35px ; width: 80px; margin-top: -30% ; margin-bottom: -19% ; margin-left: 3   0%;"></a>
            ...
            <img src="images\about1.jpg" style="width:1460px ; height:350px ; margin-left:20px ; margin-top:20px"  />

            <h1  style="margin-left:680px ; margin-top:30px "> About Us?</h1>
            <p>
    ...
    <div style="width:100% ; height">
        ...
        <div style="width:370px ; margin-left:820px ; margin-top:-250px ; height:370px">
