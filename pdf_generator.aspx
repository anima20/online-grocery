<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pdf_generator.aspx.cs" Inherits="project.pdf_generator1" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Panel ID="Panel1" runat="server" style="margin-left:300px ; margin-top:50px;width:300px">
                <table border="1px" style="font-size:20px ; width:700px">
                    <tr>
