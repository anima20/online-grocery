<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="u_data.aspx.cs" Inherits="project.u_data" %>
...
<body style="background-image:url(images/screen1.jpg);">
    ...
    <div class="tabs">
      <ul>
        <li class="login_li" style="color:yellow ; font-size:22px">Update Product</li>
      </ul>
    </div>
    ...
    <div class="login" >
      <div class="input_field" style="margin-left:10%">
          <asp:Label ID="Label1" runat="server" Text="Product Id" style="color:white ; font-size:20px"></asp:Label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            <asp:TextBox ID="TextBox5" runat="server" placeholder="Product Id" CssClass="input" Enabled="False"></asp:TextBox>
      ...
      <div class="input_field" style="margin-left:10%">
        ...
        <div class="input_field" style="margin-left:10% ; margin-top:0px ">
          <asp:Label ID="Label6" runat="server" Text="Product Price" style="color:white ; font-size:20px ; "></asp:Label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Enter Product Price" ControlToValidate="TextBox4" ForeColor="Red"></asp:RequiredFieldValidator>
      </div>
     

        <asp:Button ID="Button1" runat="server" Text="update"  style="margin-top:15px" OnClick="Button1_Click"   /><br /><br />
        <a href ="a_home.aspx" style="margin-left:41% ; color:red; " >Back to Home</a><br />
